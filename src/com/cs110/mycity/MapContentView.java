...
public class MapContentView extends MapView {
	...
	private MapContentView.OnLongpressListener longpressListener;


	public MapContentView(Context context, String apiKey) {
		super(context, apiKey);
	}

	public MapContentView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MapContentView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public void setOnLongpressListener(MapContentView.OnLongpressListener listener) {
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			longpressTimer.schedule(new TimerTask() {
				...
				public void run() {
					 ...
					 * by the caller.
					 */
					longpressListener.onLongpress(MapContentView.this, longpressLocation);
				}
