...
public class MySmack {
	...
	// Your code here ...
	public static XMPPConnection connectToGtalk(String username, String password, String status) {
		...
		XMPPConnection connection = MySmack.connectToGtalk( username,  password);
	...
	public static String processAppointment(Packet packet) {
		...
		if (chatContent.matches(
			...
			Log.d("DDDDD","STRING MATCHED MOFUCKA");
